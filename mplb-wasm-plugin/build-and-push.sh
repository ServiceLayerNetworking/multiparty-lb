...
# LB_VALUES=("leastrequest_plus_rlpb" "leastrequest_plus_rl" "nodal_leastrequest" "leastrequest_rl" "leastrequest_plus" "nodal_leastrequest" "nodal_leastrequest_rlpb" "only_nodal_leastrequest" "minimize_diff" "leastrequest")
LB_VALUES=("leastrequest_plus_rlpb" "nodal_leastrequest_rlpb")
