...
const (
	...
	NOISE                               = 2      // 2% noise
	ENFORCEMENT                         = "BOTH" // CPU_QUOTA | CPU_SHARE | BOTH
	USE_PRESET_SHARES                   = true

	LOG_FILE_PREFIX                     = "/home/twaheed2/go/src/hit"
...
func main() {
	...
	// Initialize nodes
	nodes := [3]Node{}
	nodes[0].IntializeNode("192.168.59.101",
		map[string]string{
			"app1-node1": "pod1adbb824-c353-42c5-b31c-160195a69047",
			"app3-node1": "pod2836f39b-5239-43a3-b634-19ca7bf4fd99"})
	nodes[1].IntializeNode("192.168.59.102",
		map[string]string{
			"app1-node2": "pod7486041c-bb0d-43f5-80e2-6cd95570adfb",
			"app2-node2": "pod8d2f6bb6-f761-4a1a-a168-25bb7597e829"})
	nodes[2].IntializeNode("192.168.59.103",
		map[string]string{
			"app2-node3": "pod9da2a0dd-d22e-40ac-adcb-6d0a251a0dad"})
...
func ccWithCPUShares(cpuLogFile *LogFile, nodes *[3]Node) {
...
func ccWithCPUQuotas(cpuLogFile *LogFile, nodes *[3]Node) {
...
func ccWithBoth(cpuLogFile *LogFile, nodes *[3]Node) {
...
func setDefaultCPUQuotas(nodes *[3]Node, cpuLogFile *LogFile) {
...
func setDefaultCPUShares(nodes *[3]Node, cpuLogFile *LogFile) {
...
func getPresetCPUQuotas() []string {
	return []string{
		fmt.Sprintf("app1-node1:%d app3-node1:%d", MINIMUM_CPU_QUOTA, CFS_PERIOD_US*CPUS_IN_NODE),
		fmt.Sprintf("app1-node2:%d app2-node2:%d", CFS_PERIOD_US*CPUS_IN_NODE, MINIMUM_CPU_QUOTA),
		fmt.Sprintf("app2-node3:%d", CFS_PERIOD_US*CPUS_IN_NODE),
	}
}
