...
def main():
    ...
    p.add_argument("--min-replicas", type=int, default=10, help="HPA minReplicas")
    p.add_argument("--max-replicas", type=int, default=10, help="HPA maxReplicas")
    p.add_argument("--cpu", default="500m", help="CPU request")
    p.add_argument("--memory", default="1024Mi", help="Memory request")
